...
|---|---:|---:|---|
| 基线 | 138 | 138 | 本盘点 |
| A2 完成后 | ≤ 130 | 135 | pin 纯函数 → `test/pin-geometry.test.js` |
| B1 完成后 | ≤ 120 | 128 | pin 域迁出；`main.js` 3583→3207 行 |
| B2 完成后 | ≤ 120 | 127 | capture 域迁出；`main.js` 3207→2744 行 |
| B3–B4 完成后 | ≤ 120 | **136** | long-capture + record 域迁出；`main.js` → 2174 行；新域契约测试引入少量装配断言 |
