function registerCaptureIpc({ ipcMain, controller }) {
  ...
  ipcMain.handle('long-capture:automation-start', controller.longAutomationStart)
  ipcMain.handle('long-capture:automation-scroll', controller.longAutomationScroll)
  ipcMain.handle('long-capture:automation-stop', controller.longAutomationStop)
